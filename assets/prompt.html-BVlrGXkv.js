import{_ as c,c as p,d as u,e as d,w as l,r as o,o as r,a as n,b as s}from"./app-CzxHc0as.js";const v={};function m(b,a){const t=o("CodeTabs");return r(),p("div",null,[a[4]||(a[4]=u(`<h1 id="提示词" tabindex="-1"><a class="header-anchor" href="#提示词"><span>提示词</span></a></h1><h2 id="发言稿写作专家" tabindex="-1"><a class="header-anchor" href="#发言稿写作专家"><span>发言稿写作专家</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line"># 角色：{#InputSlot placeholder=&quot;角色名称&quot; mode=&quot;input&quot;#}发言稿写作专家{#/InputSlot#}</span>
